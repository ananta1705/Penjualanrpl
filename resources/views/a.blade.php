								...
								<div class="offers_content">
									...
									<div class="offers_icons">
										<ul class="offers_icons_list">
											<li class="offers_icons_item"><img src="{{asset('travelix')}}/images/post.png" alt=""></li>
											<li class="offers_icons_item"><img src="{{asset('travelix')}}/images/compass.png" alt=""></li>
											<li class="offers_icons_item"><img src="{{asset('travelix')}}/images/bicycle.png" alt=""></li>
											<li class="offers_icons_item"><img src="{{asset('travelix')}}/images/sailboat.png" alt=""></li>
										</ul>
									</div>
